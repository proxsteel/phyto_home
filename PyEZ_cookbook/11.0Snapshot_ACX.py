#!/usr/bin/env python2
#needs 2 additional files with commands...
#disable_cmds.txt enable_syslog.txt
...
j_device = Device(host=device_ip, user='devop', password='junOSxp')
